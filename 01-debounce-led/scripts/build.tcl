...
set project_name   "debounce_led"
set project_dir    "./build"

# ---------- CONFIRM THIS ONCE YOU CHECK YOUR BOARD ----------
# Look at the silkscreen text near the FPGA chip itself, or the box -
# it will say either "Z7-10" or "Z7-20".
#   Zybo Z7-20 -> xc7z020clg400-1   (more common variant, set as default below)
...
set_property top tb_btn_led_top [get_filesets sim_1]
